...
public class FacturiGUI extends JPanel {
    private JFrame frame;
    private JLabel logoLabel;
    private JButton genereazaFacturaButton;
    private JButton facturiExistenteButton;
    private JButton backButton;

    public FacturiGUI(JFrame frame) {
        this.frame = frame;
        ...
        genereazaFacturaButton = creeazaButon("Genereaza Factura Noua", "resources/images/plus.png");
        facturiExistenteButton = creeazaButon("Facturi Existente", "resources/images/factura.png");


        gbc.gridx = 0;
        gbc.gridy = 0;
        panouPrincipal.add(genereazaFacturaButton, gbc);

        gbc.gridx = 1;
        gbc.gridy = 0;
        panouPrincipal.add(facturiExistenteButton, gbc);
        ...
        genereazaFacturaButton.addActionListener(e -> {
            frame.setContentPane(new GenereazaFacturaFrame(frame));
            frame.invalidate();
            frame.validate();
        });

        facturiExistenteButton.addActionListener(e -> {
            try {
    ...
    private void redimensioneazaComponente() {
        ...
        if (width > 0 && height > 0) {
            ...
            if (genereazaFacturaButton.getIcon() != null) {
                genereazaFacturaButton.setIcon(incarcaIconita("resources/images/plus.png", buttonSize, buttonSize));
            }
            if (facturiExistenteButton.getIcon() != null) {
                facturiExistenteButton.setIcon(incarcaIconita("resources/images/factura.png", buttonSize, buttonSize));
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Facturi GUI");
